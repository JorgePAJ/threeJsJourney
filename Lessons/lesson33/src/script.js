...
debugObject.rgbShift = rgbShiftPass.enabled;
debugObject.dotScreen = dotScreenPass.enabled;
debugObject.glitch = glitchPass.enabled;
debugObject.glitchWild = glitchPass.goWild;

gui
  .add(debugObject, "rgbShift")
  .name("RGB Shift")
  .onChange(() => {
    rgbShiftPass.enabled = debugObject.rgbShift;
  });

gui
  .add(debugObject, "dotScreen")
  .name("Dot Screen")
  .onChange(() => {
    dotScreenPass.enabled = debugObject.dotScreen;
  });

gui
  .add(debugObject, "glitch")
  .name("Glitch")
  .onChange(() => {
    glitchPass.enabled = debugObject.glitch;
  });

gui
  .add(debugObject, "glitchWild")
  .name("Glitch Go Wild")
  .onChange(() => {
    glitchPass.enabled = debugObject.glitchWild;
    glitchPass.goWild = debugObject.glitchWild;
  });
